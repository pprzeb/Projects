...
class CreationMode extends React.Component {
constructor () {
    super();
    this.state = {
        inputs: new Map([
...
return (
    <div className=''>
        <div>
            {langlistfirst?(<InputCard key={langlistfirst} inputRef={this.firstInput} langName={langlistfirst} getInput={this.getInput} value={this.state.inputs}/>):''}
        ...
        <div className='tc bg-light-purple tl ma3 pa3 br2 shadow-5 calisto b navy'>
            ...
            <WordsList langlist={langlist} remove={this.removeFromDB}/>
